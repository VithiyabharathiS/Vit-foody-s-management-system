...
public class Birthday_celebration extends JFrame implements ActionListener {
	...
	Birthday_celebration() {
		...
		birth_pic = new ImageIcon("images/birthday.jpg");
		...
		String[] time_limit = { "8.00 AM-8.30 AM", "8.30 AM-9.00 AM", "9.00 AM-9.30 AM", "9.30 AM-10.00 AM",
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == register) {
			if (first_name_textfield.getText().equals("") || last_name_textfield.getText().equals("")
					|| number_textfield.getText().equals("") || personal_email_textfield.getText().equals("")
					|| vit_email_textfield.getText().equals("")) {
