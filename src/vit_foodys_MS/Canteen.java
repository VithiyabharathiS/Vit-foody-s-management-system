...
public class Canteen extends JFrame implements ActionListener, MouseListener {
	...
	Canteen() {
		...
		canteen = new ImageIcon("images/canteen.jpg");
		pulao_pic = new ImageIcon("images/pulao.jpg");
		idly_pic = new ImageIcon("images/itly_pic.jpg");
		dosa_pizza_pic = new ImageIcon("images/dosa.jpg");
		mushroom_65_pic = new ImageIcon("images/mushroom_pic.jpg");
		fried_rice_pic = new ImageIcon("images/fried_rice.jpg");
		chicken_biryani_pic = new ImageIcon("images/chicken_biryani_pic.jpg");
		chicken_fried_rice_pic = new ImageIcon("images/chicken_fried_rice_pic.jpg");
		veg_biryani_pic = new ImageIcon("images/veg_rice_pic.jpg");
		curd_rice_pic = new ImageIcon("images/curd_rice_pic.jpg");
		meals_pic = new ImageIcon("images/meals_pic.jpg");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == button1) {
			if (!idly.isSelected() && !pulao.isSelected() && !dosa.isSelected() && !fried_rice.isSelected()
					&& !mushroom_65.isSelected() && !curd_rice.isSelected() && !chicken_fried_rice.isSelected()
					&& !chicken_biryani.isSelected() && !veg_biryani.isSelected() && !meals.isSelected()) {
