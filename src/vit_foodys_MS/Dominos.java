...
public class Dominos extends JFrame implements ActionListener, MouseListener {
	...
	Dominos() {
		...
		dominos = new ImageIcon("images/dominos.jpg");
		sicilian_pizza_pic = new ImageIcon("images/sicilian_pizza.jpg");
		chicago_style_pic = new ImageIcon("images/chicago_style.jpg");
		neapolitan_pizza_pic = new ImageIcon("images/neapolitan_pizza.jpg");
		pepsi_pic = new ImageIcon("images/pepsi.jpg");
		margherita_pizza_pic = new ImageIcon("images/margherita.jpg");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == button1) {
			if (!chicago_style.isSelected() && !sicilian_pizza.isSelected() && !neapolitan.isSelected()
					&& !margherita_pizza.isSelected() && !pepsi.isSelected()) {
