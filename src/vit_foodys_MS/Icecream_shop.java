...
public class Icecream_shop extends JFrame implements ActionListener, MouseListener {
	...
	Icecream_shop() {
		...
		icecream_pic = new ImageIcon("images/amul_icecream.jpg");
		vennila_icecream = new ImageIcon("images/vennila.jpg");
		chocolate_icecream = new ImageIcon("images/chocolate_icecream.jpg");
		butterscotch1 = new ImageIcon("images/butterscotch.jpg");
		strawberry_icecream = new ImageIcon("images/strawberry_icecream.jpg");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == button1) {
			if (!vennila.isSelected() && !butterscotch.isSelected() && !chocolate.isSelected()
					&& !strawberry.isSelected()) {
