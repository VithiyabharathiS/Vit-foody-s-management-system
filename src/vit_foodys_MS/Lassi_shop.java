...
public class Lassi_shop extends JFrame implements ActionListener, MouseListener {
	...
	Lassi_shop() {
		...
		lassi_shop = new ImageIcon("images/lassi_shop.jpg");
		limeca_juice_pic = new ImageIcon("images/limeca_juice.jpg");
		strawberry_juice_pic = new ImageIcon("images/strawberry_juice.jpg");
		oreo_milkshake_pic = new ImageIcon("images/oreo_milkshake.jpg");
		mojito_pic = new ImageIcon("images/mojito.jpg");
		mango_juice_pic = new ImageIcon("images/mango_juice.jpg");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == button1) {
			if (!strawberry_juice.isSelected() && !limeca_juice.isSelected() && !mojito_juice.isSelected()
					&& !mango_juice.isSelected() && !oreo_milk_shake.isSelected()) {
