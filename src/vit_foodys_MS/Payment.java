...
public class Payment extends JFrame implements ActionListener {
	...
	Payment(String name_title, String total_values) {
		...
		google_pay_icon = new ImageIcon("images/google pay.png");
		phonepe_icon = new ImageIcon("images/phonepe.png");
		freecharge_icon = new ImageIcon("images/freecharge.png");
		airtel_money_icon = new ImageIcon("images/airtel money.png");
		paytm_icon = new ImageIcon("images/paytm.png");
		amazon_pay_icon = new ImageIcon("images/amazon pay.png");
...
class payments extends JFrame implements ActionListener {
	...
	public void connect() {
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/dbs2?characterEncoding=utf8", "root",
					"Ranjith30052004");
		...
		if (e.getSource() == button1) {
			try {
				...
				try {
					...
					JOptionPane.showMessageDialog(null, "Please Enter the Number", "Incomplete",
					...
					if (rs.next()) {
						...
						if (amount1 < 0) {
							JOptionPane.showMessageDialog(null,
									name + " , Your Account Balance is lesser than Total Amount", "Low Balance",
									JOptionPane.WARNING_MESSAGE);

						} else if (!password.equals(password2)) {
							JOptionPane.showMessageDialog(null, name + " , Your Password is Incorrect", "Incorrect",
							...
							JOptionPane.showMessageDialog(null, name + " , Amount Successfully Paid", "Payment",
						...
						JOptionPane.showMessageDialog(null, "Number or Password is Incorrect", "Incorrect",
								JOptionPane.ERROR_MESSAGE);
					}
				}
			} catch (Exception ex) {
...
class thank extends JFrame {
	...
	thank() throws InterruptedException {
		Image logo = Toolkit.getDefaultToolkit().getImage("images/logo.jpg");
		ImageIcon thank_you = new ImageIcon("images/thank.gif");
